...
<section class="rt_wrap content mCustomScrollbar">
  <div class="rt_content">
     <div class="page_title">
       <h2 class="fl">文章列表</h2>
       <a href="/Admin/Article/add" class="fr top_rt_btn add_icon">新建文章</a>
      </div>
      ...
      <form action="/Admin/Article/delall" method="post">
       ...
       <tr>
        ...
        <th>操作</th>
         ...
         <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
          ...
          <td class="center"> 
           <?php if($v['recommend'] == 0): ?>未推荐
             <?php else: ?>
                推荐<?php endif; ?>
          </td>
          <td class="center">
            <?php if($v['pic'] != ''): ?><img src="/<?php echo ($v["pic"]); ?>" height="60px;" width="80px" />
             <?php else: ?>
                暂无缩略图<?php endif; ?>
          </td>
          <td class="center"><?php echo ($v["catename"]); ?></td>
          <td class="center">
           <a href="/Admin/Article/edit/id/<?php echo ($v["id"]); ?>" title="编辑" class="link_icon">&#101;</a>
           <a href="/Admin/Article/tolst/id/<?php echo ($v["id"]); ?>" title="还原到文章列表" class="link_icon">&#47;</a>
           <a title="删除" class="link_icon" onclick="return confirm('确定要彻底删除该文章吗？');" href="/Admin/Article/del/id/<?php echo ($v["id"]); ?>">&#100;</a>
          </td>
