...
<section class="rt_wrap content mCustomScrollbar">
  <div class="rt_content">
     ...
     <form action="/Admin/Cate/edit" method="post" id="myform" name="myform" enctype="multipart/form-data">
     <input type="hidden" name="id" value="<?php echo ($cates["id"]); ?>">
     <section>
      <ul class="ulColumn2">
       <li>
        <span class="item_name" style="width:120px;">栏目名称：</span>
        <input type="text" class="textbox textbox_295" name="catename" value="<?php echo ($cates["catename"]); ?>" placeholder="栏目名称..."/>
