...
<section class="rt_wrap content mCustomScrollbar">
  <div class="rt_content">
     <div class="page_title">
      ...
      <form action="/Admin/Message/toTrachAll" method="post">
      ...
      <table class="table">
       <tr>
        ...
        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
          ...
          <td class="center">
           <a href="/Admin/Message/reply/id/<?php echo ($v["id"]); ?>" title="回复" class="link_icon">&#101;</a>
           <a href="/Admin/Message/checked/id/<?php echo ($v["id"]); ?>" title="审核" class="link_icon">&#118;</a>
           <a title="删除到回收站" class="link_icon" onclick="return confirm('确定要删除该留言到回收站吗？');" href="/Admin/Message/toTrach/id/<?php echo ($v["id"]); ?>">&#100;</a>
          </td>
