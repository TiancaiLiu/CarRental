...
<section class="rt_wrap content mCustomScrollbar">
  <div class="rt_content">
     <div class="page_title">
       <h2 class="fl">栏目回收站</h2>
       <a href="/Admin/Cate/lst" class="fr top_rt_btn add_icon">返回栏目列表</a>
      </div>
      ...
      <form action="/Admin/Cate/delall" method="post">
       <input type="submit" name="submit" class="link_btn" value="批量删除" />
      <table class="table">
       <tr>
        <th style="width:10%"><input type="checkbox" name="chkall" id="all"> 全选</th>
        ...
        <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
          ...
          <td class="center">
           <a href="/Admin/Cate/tolst/id/<?php echo ($v["id"]); ?>" title="还原到栏目列表" class="link_icon">&#47;</a>
           <a title="彻底删除" class="link_icon" onclick="return confirm('确定要删除该栏目吗？');" href="/Admin/Cate/del/id/<?php echo ($v["id"]); ?>">&#100;</a>
          </td>
