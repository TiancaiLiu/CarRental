...
<section class="rt_wrap content mCustomScrollbar">
  <div class="rt_content">
    ...
    <form action="/Admin/Message/checked" method="post" enctype="multipart/form-data">
  	<table cellspacing="0" cellpadding="3" border="1" align="center">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input name="checked" type="checkbox" value="1" <?php if($message["checked"] == 1): ?>checked="checked"<?php endif; ?> />通过审核</td>
            </tr>
            <tr>
                <th></th>
                <td>
