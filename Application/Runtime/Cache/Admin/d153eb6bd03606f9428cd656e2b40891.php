...
<section class="rt_wrap content mCustomScrollbar">
  <div class="rt_content">
     <div class="page_title">
       ...
       <a href="/Admin/Manage/add" class="fr top_rt_btn add_icon">添加管理员</a>
      </div>
      <form action="/Admin/Manage/search" method="post">
      <section class="mtb">
       <input type="text" name="keywords" class="textbox textbox_225" placeholder="输入管理员关键字..."/>
       <input type="submit" value="查询" class="group_btn"/>
      </section>
      </form>
      <form action="/Admin/Manage/delall" method="post">
      ...
      <table class="table">
       ...
       <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
          ...
          <td class="center">
           <a href="/Admin/Manage/edit/id/<?php echo ($v["id"]); ?>" title="编辑" class="link_icon">&#101;</a>
           <a title="删除" class="link_icon" onclick="return confirm('确定要删除该管理员吗？');" href="/Admin/Manage/del/id/<?php echo ($v["id"]); ?>">&#100;</a>
          </td>
