...
<section class="rt_wrap content mCustomScrollbar">
  <div class="rt_content">
	<h1 style="text-align: center;font-size: 25px;margin-top: 150px;"><strong>欢迎来到《盘古租车》后台管理系统</strong></h1>
	<h2 style="text-align: center;"><a href="/Admin/Manage/edit/id/<?php echo $_SESSION['id']?>"><?php echo $_SESSION['username']?></a>，您好管理员</h2>
  </div>
</section>
</body>
</html>