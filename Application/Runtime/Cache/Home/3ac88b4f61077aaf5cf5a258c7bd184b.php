...
<ul class="nav">
  ...
  <?php if(is_array($cates)): foreach($cates as $key=>$v): ?><li>
   	 <a href="/Home/<?php if($v['id'] == 1): ?>Aboutus<?php elseif($v['id'] == 2): ?>Intro<?php elseif($v['id'] == 3): ?>Rental<?php elseif($v['id'] == 4): ?>Return<?php elseif($v['id'] == 5): ?>Moneylist<?php elseif($v['id'] == 6): ?>Activitylist<?php elseif($v['id'] == 7): ?>Carlist<?php elseif($v['id'] == 8): ?>Maintain<?php elseif($v['id'] == 9): ?>Contact<?php endif; ?>/index/cateid/<?php echo ($v["id"]); ?>" title="关于我们">
   	 <?php echo ($v["catename"]); ?>
   	 </a>
...
<!--head-->
    <div class="content">
        <div class="about"><p><span style="font-size:14px;"><span style="color: rgb(0, 0, 0); font-family: 微软雅黑; line-height: 41.04px;"><?php echo ($rent); ?></span></span></p>
        </div>          
    </div>
<div class="footer">
