...
<!--head-->
    <div class="content">
        <div class="about">
                ...
                <h1 style="color:#f60">日租：<?php echo ($arts["rental"]); ?>元/天</h1>
                <center><img src="/<?php echo ($arts["pic"]); ?>" /></center>       
                <span class="picContent"><p><?php echo htmlspecialchars_decode($arts['content']);?></p></span>
                <a href="<?php echo ($upurl); ?>" title="<?php echo ($uptitle); ?>" class="page">上一条：<?php echo ($uptitle); ?></a> 
                <a href="<?php echo ($downurl); ?>" title="<?php echo ($downtitle); ?>" class="page">下一条：<?php echo ($downtitle); ?></a> 
                <a href="/Home/Carlist/index/cateid/7" title="返回列表" class="back">返回列表</a>        
        </div>          
    </div>
<div class="footer">
